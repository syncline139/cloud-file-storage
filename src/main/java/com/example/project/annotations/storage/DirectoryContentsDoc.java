...
@Operation(
        ...
        description = "Коллекция ресурсов, лежащих в папке (не рекурсивно)"
)
@Parameter(
        name = "path",
        description = "Полный путь к ресурсу в URL-encoded формате (например, 'folder1/folder2/'). Путь к папке должен заканчиваться на '/'.",
        required = true,
...
@ApiResponses(value = {
        @ApiResponse(
                responseCode = "200",
                description = "Информация о содержимом успешно получена",
                content = @Content(
        ...
        @ApiResponse(
                ...
                content = @Content(
                        ...
                        examples = @ExampleObject(
                                value = """
                    {
                      "message": "Ошибка при получении информации о директории",
                      "statusCode": 500,
                      "timestamp": 1713203213000
                    }
                    """
...
public @interface DirectoryContentsDoc {
}
